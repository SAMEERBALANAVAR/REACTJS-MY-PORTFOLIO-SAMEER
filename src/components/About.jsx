...
const About = () => {
  ...
  const [state] = React.useState([
    { id: 1, title: "Name:", text: "Sameer Balanavar" },
    { id: 2, title: "Email:", text: "sameerbunty@domain.com" },
    { id: 3, title: "Phone:", text: "+91 97397 90642" },
    { id: 4, title: "Linkedin", text: "Its_SameerBunty" }
  ]);
  return (
    <div className="about">
        ...
        <div className="row  h-650 alignCenter">
          <div className="col-6">
            <div className="about__img">
              <img src="/images/bunty1.png" alt="man" />
            </div>
          </div>
          <div className="col-6">
